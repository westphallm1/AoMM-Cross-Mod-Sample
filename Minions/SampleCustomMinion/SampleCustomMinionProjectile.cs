...
{
	/// <summary>
	/// Minion Projectile with full custom AI that determines projectile behavior based on
	/// AoMM-provided state values.
	/// </summary>
	internal class SampleCustomMinionProjectile : ModProjectile
	{
		public override string Texture => "Terraria/Images/Projectile_" + ProjectileID.BlueFairy;

		private IAoMMState aommState { get; set; } = new AoMMStateImpl();

		public override void SetStaticDefaults()
		{
			Main.projFrames[Type] = Main.projFrames[ProjectileID.BlueFairy];
		...
		public override void AI()
		{
			...
			if(Main.player[Projectile.owner].HasBuff(BuffType<SampleCustomMinionBuff>()))
			{
